...
import com.chresh.bluemapfabricwaystonemarkersmod.actions.AddMarkerAction;
import com.chresh.bluemapfabricwaystonemarkersmod.actions.MarkerAction;
import com.chresh.bluemapfabricwaystonemarkersmod.actions.RemoveMarkerAction;
import com.chresh.bluemapfabricwaystonemarkersmod.actions.UpdateMarkerAction;
import com.chresh.bluemapfabricwaystonemarkersmod.markers.MarkerGroupType;
import com.chresh.bluemapfabricwaystonemarkersmod.markers.MarkerSetIdentifier;
import com.chresh.bluemapfabricwaystonemarkersmod.reactive.ReactiveQueue;
        ...
        if (markerAction instanceof AddMarkerAction addAction) {
            ...
            if (markerGroup.type() == MarkerGroupType.POI) {
                ...
                var markerBuilder = POIMarker.builder()
                        .position(addAction.getEntityPos().getX(), addAction.getEntityPos().getY(), addAction.getEntityPos().getZ())
